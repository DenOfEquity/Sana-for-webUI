...
class Sana_Pipeline_DoE(DiffusionPipeline, PAGMixin):
    ...
    def __init__(
        ...
        self.mask_processor  = VaeImageProcessor(vae_scale_factor=self.vae_scale_factor, vae_latent_channels=32, 
    ...
    def __call__(
        ...
        (
            nul_prompt_embeds,
            nul_prompt_attention_mask,
        ) = self.encode_prompt(
            None,
            num_images_per_prompt=num_images_per_prompt,
            device=device,
            prompt_embeds=nul_prompt_embeds,
            prompt_attention_mask=nul_prompt_attention_mask,
            clean_caption=clean_caption,
            max_sequence_length=max_sequence_length,
        )
